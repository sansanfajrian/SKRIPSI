...
const EditProject = () => {
  ...
  useEffect(() => {
    ...
    let {id, name, description, requirement, deadlineDate, documents} = location.state;
    setEditProjectRequest({id, name, description, requirement, deadlineDate, documents});
  ...
  const saveProject = (e) => {
    ...
    formData.append("deletedDocumentIds", editProjectRequest.documents.filter(doc => doc.deleted).map(doc => doc.id));
                        ...
                        <div className="mb-3">
                          ...
                          <div className="row">
                            <div className="col-md-6">
                              ...
                              {(editProjectRequest.documents.length === 0 && documents.length === 0) && (<i>This project has no documents uploaded</i>)}

                              <ul className="nav flex-column">
                                {[...editProjectRequest.documents].map((doc, index) => (
